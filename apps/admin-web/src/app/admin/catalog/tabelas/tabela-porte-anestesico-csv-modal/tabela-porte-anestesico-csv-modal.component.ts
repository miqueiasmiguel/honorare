...
@Component({
  ...
  templateUrl: './tabela-porte-anestesico-csv-modal.component.html',
  styleUrl: './tabela-porte-anestesico-csv-modal.component.scss',
})
export class TabelaPorteAnestesicoCsvModalComponent {
  @Input() operadoraId = '';
  ...
  readonly resultado = signal<ImportarTabelaPorteResult | null>(null);
